function initGraph() {
  ...
  var echartPie = echarts.init(document.getElementById('gender_statistics_graph'), theme);
  ...
  echartPie.setOption({
    ...
    series: [{
      ...
      // center: ['50%', '48%'],
      data: [{
        value: gender_static.male,
        name: '男'
      }, {
        value: gender_static.female,
        name: '女'
      }, {
        value: gender_static.other,
        name: '其他'
      }]
    }]
  });
  ...
  let maxinum = 0;
  for (let i in province_statistics) {
