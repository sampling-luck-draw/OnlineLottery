...
function getParticipants(activity_id = -1) {
    if (activity_id === -1) {
        let children = $("#history-activity-list").children();
    ...
    $.ajax({
        ...
        method: 'GET',
        success: function(e) {
            let table_body = $("#participant-table-body");
            for (let i in e) {
                let participant = e[i];
                let avatar = participant['fields']['avatarUrl'];
                avatar = avatar.substr(0, avatar.lastIndexOf("/")) + '/46';
                table_body.append('<tr>' +
                    '<td><img src="'+ avatar +'"/></td>' +
                    '<td>'+ participant['fields']['nickName'] +'</td>' +
                    '<td>'+ participant['fields']['gender'] +'</td>' +
                    '<td>'+ participant['fields']['province'] +'</td>' +
                    '<td>'+ participant['fields']['city'] +'</td>' +
